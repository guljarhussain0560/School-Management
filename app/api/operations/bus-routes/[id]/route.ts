...
export async function GET(
  ...
  try {
    ...
    const route = await prisma.busRoute.findFirst({
      ...
      include: {
        bus: {
          select: { id: true, busNumber: true, busName: true, driverName: true, driverPhone: true, conductorName: true, conductorPhone: true, capacity: true }
        },
        manager: {
    ...
    logger.error('Error fetching bus route:', error);
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    logger.error('Error updating bus route:', error);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    logger.error('Error deleting bus route:', error);
    return NextResponse.json(
